                            ...
                            <div  class="hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                                ...
                                <a href="timeline.html">
                                    <div class="p-4 py-5 flex items-center gap-4">
                                        ...
                                        <div class="flex-1">
                                            <h4 class="text-sm font-medium text-black"> <?php echo htmlspecialchars($firstName . " ". $lastName);?> </h4>
                                ...
                                <div>
                                    <div class="flex items-center gap-2.5">
                                        <button type="button" class="button-icon text-red-500 bg-red-100 dark:bg-slate-700"> <ion-icon class="text-lg" name="heart"></ion-icon> </button>
                                         <!--<a href="#">1,300</a> code hii ya "like button nimeibadillisha"-->
                                         <form method="POST" action="handle_likes.php">
                                         <input type= "hidden" name="post_id" value="<?php echo"<p>Likes: $likes_count</p> $post_id";?>">
...
// SQL query to fetch posts in chronological order
$sql = "SELECT id, user_id, content, created_at FROM posts ORDER BY created_at ASC";
...
?>
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <!-- add comment -->
                            <div class="sm:px-4 sm:py-3 p-2.5 border-t border-gray-100 flex items-center gap-1 dark:border-slate-700/40">y
                       ...
                       <!--POSTS YANGU-->
                            ...
                            <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                                <a href="timeline.html"> <img src="assets/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full"> </a> 
                                <div class="flex-1">
                                    <a href="timeline.html"> <h4 class="text-black dark:text-white"> Majina Mawili </h4> </a> 
